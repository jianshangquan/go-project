...
const file_proto_hello_proto_rawDesc = "" +
	"\n" +
	"\x11proto/hello.proto\x12\x10com.theparadance\"0\n" +
	...
	"\b_message2S\n" +
	"\aGreeter\x12H\n" +
	"\bSayHello\x12\x1e.com.theparadance.HelloRequest\x1a\x1c.com.theparadance.HelloReplyB\x1aZ\x18/proto-generated/greeterb\x06proto3"
...
var file_proto_hello_proto_goTypes = []any{
	(*HelloRequest)(nil), // 0: com.theparadance.HelloRequest
	(*HelloReply)(nil),   // 1: com.theparadance.HelloReply
}
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: com.theparadance.Greeter.SayHello:input_type -> com.theparadance.HelloRequest
	1, // 1: com.theparadance.Greeter.SayHello:output_type -> com.theparadance.HelloReply
...
func file_proto_hello_proto_init() {
	...
	file_proto_hello_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
